...
public class BoardEnrollFormController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Category> list = new NBoardService().selectCategoryList();
	
		request.setAttribute("list"	, list);
		request.getRequestDispatcher("views/normalboard/nBoardErollForm.jsp").forward(request, response);
	}
